...
Raw Table Data: Length 566 (0x236)
    ...
    0040: 00 00 00 24 4C 35 43 4E 31 38 57 57 00 00 00 00  // ...$L5CN18WW....
    0050: 00 00 00 00 00 00 00 00 00 00 00 00 24 48 4C 43  // ............$HLC
    0060: 33 44 00 00 00 00 00 00 00 00 00 00 00 00 00 00  // 3D..............
    ...
    0160: FF FF FF FF FF 24 42 4D 45 24 00 90 DC 00 00 10  // .....$BME$......
    0170: 00 00 24 00 00 00 01 00 00 00 00 24 00 FF FF FF  // ..$........$....
    0180: FF FF FF FF FF 24 5F 4D 53 43 5F 56 45 52 3D 40  // .....$_MSC_VER=@
    0190: 06 24 52 44 41 54 45 23 09 20 24 45 53 52 54 18  // .$RDATE#. $ESRT.
    01A0: 00 73 60 C3 F8 82 ED 48 52 15 4E A1 49 3F 4A 9B  // .s`....HR.N.I?J.
    01B0: 5E F9 5A 8B 01 00 00 24 45 4E 44 4F 46 42 56 44  // ^.Z....$ENDOFBVD
